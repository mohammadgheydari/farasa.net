        ...
        <div class="col s12 m12 l9 right">
            <div class=" card z-depth-1 card-content white">
                ...
                <section>
                    ...
                    <a href="#" class="waves-effect waves-light btn teal darken-3  ">تلگرام</a>
                    <a href="#" class="waves-effect waves-light btn teal darken-3  ">بله</a>
                    <p><small>عدد 1 را به 3025 ارسال کنید</small></p>
                </section>
               
               <section>
                    <p><span class="number">2</span> اپلیکیشن موبایل را نصب کنید</p>
                    <a href="#" class="waves-effect waves-light btn teal darken-3 margin-bottom-10">لینک دانلود اندروید</a>
                    <a href="#" class="waves-effect waves-light btn teal darken-3 margin-bottom-10">لینک دانلود ios</a>
                    <br>
